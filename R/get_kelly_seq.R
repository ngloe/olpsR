# ---- Kelly Propjection ----
#
# Purpose:  function to transform any sequence of price relatives
#           into  a "Kelly sequence". That is, for each trading 
...
# Input:    Matrix of price relatives (rows=time, columns=assets)
#
# ------------------------------------------------------
